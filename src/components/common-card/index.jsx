...
function CommonCard({
  ...
  return (
    <Card className="bg-gray-100 flex flex-col gap-6 rounded-2xl p-8 transition duration-300 hover:bg-white hover:shadow-2xl hover:shadow-gray-600/10 cursor-pointer">
